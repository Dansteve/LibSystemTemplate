...
class Student(User):
    """
    Student class to represent a student in the library
    ...
    def menu(self):
        """ 
        Display the menu for the Student.\n
        ...
        print("\n", "*"*50, sep="")
        print(f"""Welcome {self.f_name} {self.l_name} to the menu for 'Student'""")
        while True:
            print(f"""
Choose an option:
1.  Search for a book
...
""")
    ...
    def __repr__(self):
        ...
        """
        return f"Student({self.f_name}, {self.l_name}, {self.department}, {self.account})"
